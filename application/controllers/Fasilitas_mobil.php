...
class Fasilitas_mobil extends CI_Controller
{
    ...
    public function json() {
        ...
        echo $this->M_fasilitas_mobil->json();
    }

    public function read($id) 
    {
        $row = $this->M_fasilitas_mobil->get_by_id($id);
        if ($row) {
            $data = array(
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_fasilitas_mobil->insert($data);
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_fasilitas_mobil->update($this->input->post('ID_MOBIL', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->M_fasilitas_mobil->delete($id);
