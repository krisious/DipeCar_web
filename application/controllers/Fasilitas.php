...
class Fasilitas extends CI_Controller
{
    ...
    {
        $data['data']=$this->M_fasilitas->get_all();
    ...
    public function json() {
        ...
        echo $this->M_fasilitas->json();
    }

    public function read($id) 
    {
        $row = $this->M_fasilitas->get_by_id($id);
        if ($row) {
            $data = array(
    ...
    public function update_action() 
    {
		...
		'BIAYA' => $this->input->post('BIAYA',TRUE),
            ...
            $this->M_fasilitas->update($this->input->post('ID_FASILITAS', TRUE), $data);
